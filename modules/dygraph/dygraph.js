  ...
  })(
    {
      ...
      2: [
        function (require, module, exports) {
          ...
          /** @inheritDoc */
          CustomBarsHandler.prototype.extractSeries = function (
            rawData,
            i,
            options
          ) {
      ...
      3: [
        function (require, module, exports) {
          ...
          /** @inheritDoc */
          ErrorBarsHandler.prototype.extractSeries = function (
            rawData,
            i,
            options
          ) {
      ...
      4: [
        function (require, module, exports) {
          ...
          /** @inheritDoc */
          FractionsBarsHandler.prototype.extractSeries = function (
            rawData,
            i,
            options
          ) {
            ...
            for (var j = 0; j < rawData.length; j++) {
              ...
              if (point !== null) {
                ...
                if (num !== null && !isNaN(num)) {
                  ...
                  stddev = den
                    ? sigma * Math.sqrt((value * (1 - value)) / den)
                    : 1.0;
        ...
        function (require, module, exports) {
          ...
          BarsHandler.prototype.onPointsCreated_ = function (series, points) {
            for (var i = 0; i < series.length; ++i) {
              ...
              point.y_top = NaN;
              point.y_bottom = NaN;
              point.yval_minus = _datahandler2["default"].parseFloat(
                item[2][0]
              );
          ...
          BarsHandler.prototype.onLineEvaluated = function (
            ...
            for (var j = 0; j < points.length; j++) {
              ...
              point = points[j];
              point.y_top = _dygraphLayout2["default"].calcYNormal_(
                axis,
                point.yval_minus,
                logscale
              );
              point.y_bottom = _dygraphLayout2["default"].calcYNormal_(
                axis,
                point.yval_plus,
                logscale
              );
      ...
      7: [
        function (require, module, exports) {
          ...
          DefaultFractionHandler.prototype.extractSeries = function (
            rawData,
            i,
            options
          ) {
      ...
      8: [
        function (require, module, exports) {
          ...
          /** @inheritDoc */
          DefaultHandler.prototype.extractSeries = function (
            rawData,
            i,
            options
          ) {
      ...
      9: [
        function (require, module, exports) {
           ...
           */
          var DygraphCanvasRenderer = function DygraphCanvasRenderer(
            dygraph,
            element,
            elementContext,
            layout
          ...
          DygraphCanvasRenderer._drawStyledLine = function (
            ...
            var drawGapPoints = g.getBooleanOption(
              "drawGapEdgePoints",
              e.setName
            );
          ...
          DygraphCanvasRenderer.prototype._renderLineChart = function (
            ...
            for (i = 0; i < plotters.length; i++) {
              ...
              for (var j = 0; j < sets.length; j++) {
                ...
                var strokeWidth = this.dygraph_.getOption(
                  "strokeWidth",
                  setName
                );
          ...
          DygraphCanvasRenderer._fillPlotter = function (e) {
            ...
            var traceBackPath = function traceBackPath(
              ctx,
              baselineX,
              baselineY,
              pathBack
            ...
            for (var setIdx = setCount - 1; setIdx >= 0; setIdx--) {
              ...
              if (
                ...
                _dygraph2["default"].FORCE_FAST_PROXY
              ) {
      ...
      10: [
        function (require, module, exports) {
          ...
          var _dygraphInteractionModel2 = _interopRequireDefault(
      ...
      11: [
        function (require, module, exports) {
          ...
          GVizChart.prototype.draw = function (data, options) {
            ...
            this.date_graph = new _dygraph2["default"](
              this.container,
              data,
              options
            );
        ...
        function (require, module, exports) {
          ...
          DygraphInteraction.startPan = function (event, g, context) {
            ...
            if (g.getOptionForAxis("logscale", "x")) {
              ...
              context.dateRange =
                utils.log10(xRange[1]) - utils.log10(xRange[0]);
            } else {
            ...
            if (g.getNumericOption("panEdgeFraction")) {
              ...
              var boundedRightX =
                g.toDomXCoord(xExtremes[1]) + maxXPixelsToDraw;
          ...
          DygraphInteraction.movePan = function (event, g, context) {
            ...
            if (context.is2DPan) {
              ...
              for (var i = 0; i < g.axes_.length; i++) {
                ...
                var boundedValue = context.boundedValues
          ...
          DygraphInteraction.moveZoom = function (event, g, context) {
            ...
            context.dragDirection =
              xDelta < yDelta / 2 ? utils.VERTICAL : utils.HORIZONTAL;
           ...
           * @param {Object} context
           */
          DygraphInteraction.treatMouseOpAsClick = function (
            g,
            event,
            context
          ) {
          ...
          DygraphInteraction.moveTouch = function (event, g, context) {
            ...
            var dataWidth =
              context.initialRange.x[1] - context.initialRange.x[0];
            var dataHeight =
          ...
          var distanceFromInterval = function distanceFromInterval(
            x,
            left,
            right
          ) {
    ...
    */
      ...
      13: [
        function (require, module, exports) {
          ...
          DygraphLayout.prototype._evaluateLimits = function () {
            ...
            if (this.dygraph_.getOptionForAxis("logscale", "x")) {
              this._xAxis.xlogrange =
                utils.log10(this._xAxis.maxval) -
                utils.log10(this._xAxis.minval);
            ...
            for (var i = 0; i < this.yAxes_.length; i++) {
              ...
              if (this.dygraph_.getOption("logscale")) {
                axis.ylogrange =
                  utils.log10(axis.maxyval) - utils.log10(axis.minyval);
                axis.ylogscale =
                  axis.ylogrange !== 0 ? 1.0 / axis.ylogrange : 1.0;
          ...
          DygraphLayout.calcXNormal_ = function (value, xAxis, logscale) {
            if (logscale) {
              return (
                (utils.log10(value) - utils.log10(xAxis.minval)) *
                xAxis.xlogscale
              );
            } else {
          ...
          DygraphLayout.calcYNormal_ = function (axis, value, logscale) {
            if (logscale) {
              var x =
                1.0 -
                (utils.log10(value) - utils.log10(axis.minyval)) *
                  axis.ylogscale;
          ...
          DygraphLayout.prototype._evaluateLineCharts = function () {
            ...
            var isLogscaleForX = this.dygraph_.getOptionForAxis(
              "logscale",
              "x"
            );
            ...
            for (var setIdx = 0; setIdx < this.points.length; setIdx++) {
              ...
              var connectSeparated = this.dygraph_.getOption(
                "connectSeparatedPoints",
                setName
              );
              var axis = this.dygraph_.axisPropertiesForSeries(setName);
              // TODO (konigsberg): use optionsForAxis instead.
              var logscale = this.dygraph_.attributes_.getForSeries(
                "logscale",
                setName
              );
              ...
              this.dygraph_.dataHandler_.onLineEvaluated(
                points,
                axis,
                logscale
              );
                ...
                OPTIONS_REFERENCE =
                  // <JSON>
                  {
                    ...
                    drawPointCallback: {
                      ...
                      description:
                        "Draw a custom item when drawPoints is enabled. Default is a small dot matching the series color. This method should constrain drawing to within pointSize pixels from (cx, cy).  Also see <a href='#drawHighlightPointCallback'>drawHighlightPointCallback</a>",
                    },
                    height: {
                      default: "320",
                    ...
                    pointClickCallback: {
                      snippet:
                        "function(e, point){<br>&nbsp;&nbsp;alert(point);<br>}",
                      default: "null",
                      ...
                      parameters: [
                        ...
                        [
                          "point",
                          "the point that was clicked See <a href='#point_properties'>Point properties</a> for details",
                        ],
                      ],
                      description:
                    ...
                    highlightCallback: {
                      ...
                      parameters: [
                        ...
                        [
                          "points",
                          "an array of highlighted points: <code>[ {name: 'series', yval: y-value}, &hellip; ]</code>",
                        ],
                        [
                          "row",
                    ...
                    drawHighlightPointCallback: {
                      ...
                      description:
                        "Draw a custom item when a point is highlighted.  Default is a small dot matching the series color. This method should constrain drawing to within pointSize pixels from (cx, cy) Also see <a href='#drawPointCallback'>drawPointCallback</a>",
                    },
                    highlightSeriesOpts: {
                      default: "null",
                    ...
                    labelsSeparateLines: {
                      ...
                      type: "boolean",
                      description:
                        "Put <code>&lt;br/&gt;</code> between lines in the label string. Often used in conjunction with <strong>labelsDiv</strong>.",
                    },
                    valueFormatter: {
                      ...
                      description:
                        "Function to provide a custom display format for the values displayed on mouseover. This does not affect the values that appear on tick marks next to the axes. To format those, see axisLabelFormatter. This is usually set on a <a href='per-axis.html'>per-axis</a> basis. .",
                      parameters: [
                        [
                          "num_or_millis",
                          "The value to be formatted. This is always a number. For date axes, it's millis since epoch. You can call new Date(millis) to get a Date object.",
                        ],
                        [
                          "opts",
                        ...
                        [
                          "col",
                          "The column of the data from which this point comes. g.getValue(row, col) will return the original y-value for this point. This can be used to get the full confidence interval for the point, or access un-rolled values for the point.",
                        ],
                      ],
                    },
                    ...
                    labelsKMG2: {
                      ...
                      type: "boolean",
                      description:
                        "Show k/M/G for kilo/Mega/Giga on y-axis. This is different than <code>labelsKMB</code> in that it uses base 2, not 10.",
                    },
                    delimiter: {
                      default: ",",
                      labels: ["CSV parsing"],
                    ...
                    pixelsPerLabel: {
                      ...
                      type: "integer",
                      description:
                        "Number of pixels to require between each x- and y-label. Larger values will yield a sparser axis with fewer ticks. This is set on a <a href='per-axis.html'>per-axis</a> basis.",
                    },
                    labelsDiv: {
                      default: "null",
                      labels: ["Legend"],
                      ...
                      example:
                        "<code style='font-size: small'>document.getElementById('foo')</code>or<code>'foo'",
                      description:
                    ...
                    logscale: {
                      ...
                      type: "boolean",
                      description:
                        "When set for the y-axis or x-axis, the graph shows that axis in log scale. Any values less than or equal to zero are not displayed. Showing log scale with ranges that go below zero will result in an unviewable graph.\n\n Not compatible with showZero. connectSeparatedPoints is ignored. This is ignored for date-based x-axes.",
                    },
                    strokeWidth: {
                      default: "1.0",
                      labels: ["Data Line display"],
                    ...
                    fillGraph: {
                      ...
                      type: "boolean",
                      description:
                        "Should the area underneath the graph be filled? This option is not compatible with error bars. This may be set on a <a href='per-axis.html'>per-series</a> basis.",
                    },
                    highlightCircleSize: {
                      default: "3",
                      labels: ["Interactive Elements"],
                    ...
                    visibility: {
                      ...
                      description:
                        "Which series should initially be visible? Once the Dygraph has been constructed, you can access and modify the visibility of each series using the <code>visibility</code> and <code>setVisibility</code> methods.",
                    },
                    valueRange: {
                    ...
                    colorSaturation: {
                      ...
                      type: "float (0.0 - 1.0)",
                      description:
                        "If <strong>colors</strong> is not specified, saturation of the automatically-generated data series colors.",
                    },
                    ...
                    legendFormatter: {
                      ...
                      params: [
                        [
                          "data",
                          'An object containing information about the selection (or lack of a selection). This includes formatted values and series information. See <a href="https://github.com/danvk/dygraphs/pull/683">here</a> for sample values.',
                        ],
                      ],
                      description:
                        'Set this to supply a custom formatter for the legend. See <a href="https://github.com/danvk/dygraphs/pull/683">this comment</a> and the <a href="tests/legend-formatter.html">legendFormatter demo</a> for usage.',
                    },
                    ...
                    axisLabelFormatter: {
                      ...
                      parameters: [
                        ...
                        [
                          "granularity",
                          "specifies how fine-grained the axis is. For date axes, this is a reference to the time granularity enumeration, defined in dygraph-tickers.js, e.g. Dygraph.WEEKLY.",
                        ],
                        [
                          "opts",
                      ...
                      description:
                        "Function to call to format the tick values that appear along an axis. This is usually set on a <a href='per-axis.html'>per-axis</a> basis.",
                    },
                    clickCallback: {
                      snippet:
                        "function(e, date_millis){<br>&nbsp;&nbsp;alert(new Date(date_millis));<br>}",
                      default: "null",
                      labels: ["Callbacks"],
                      ...
                      parameters: [
                        ...
                        [
                          "points",
                          "The closest points along that date. See <a href='#point_properties'>Point properties</a> for details.",
                        ],
                      ],
                      description:
                    ...
                    y2label: {
                      ...
                      default: "null",
                      description:
                        "Text to display to the right of the chart's secondary y-axis. This label is only displayed if a secondary y-axis is present. See <a href='http://dygraphs.com/tests/two-axes.html'>this test</a> for an example of how to do this. The comments for the 'ylabel' option generally apply here as well. This label gets a 'dygraph-y2label' instead of a 'dygraph-ylabel' class.",
                    },
                    yLabelWidth: {
                      labels: ["Chart labels"],
                      type: "integer",
                    ...
                    file: {
                      ...
                      description:
                        "Sets the data being displayed in the chart. This can only be set when calling updateOptions; it cannot be set from the constructor. For a full description of valid data formats, see the <a href='http://dygraphs.com/data.html'>Data Formats</a> page.",
                    },
                    timingName: {
                      default: "null",
                    ...
                    plotter: {
                      default:
                        "[DygraphCanvasRenderer.Plotters.fillPlotter, DygraphCanvasRenderer.Plotters.errorPlotter, DygraphCanvasRenderer.Plotters.linePlotter]",
                      labels: ["Data Line display"],
                    ...
                    axes: {
                      ...
                      type: "Object",
                      description:
                        "Defines per-axis options. Valid keys are 'x', 'y' and 'y2'. Only some options may be set on a per-axis basis. If an option may be set in this way, it will be noted on this page. See also documentation on <a href='http://dygraphs.com/per-axis.html'>per-series and per-axis options</a>.",
                    },
                    series: {
                      default: "null",
                      labels: ["Series"],
                ...
                for (var k in OPTIONS_REFERENCE) {
                  ...
                  for (i = 0; i < flds.length; i++) {
                    if (!op.hasOwnProperty(flds[i])) {
                      warn(
                        "Option " + k + ' missing "' + flds[i] + '" property'
                      );
                  ...
                  if (typeof labels !== "object") {
                    warn(
                      'Option "' + k + '" is missing a "labels": [...] option'
                    );
                  } else {
      ...
      15: [
        function (require, module, exports) {
          (function (process) {
            ...
            var _dygraphDefaultAttrs2 =
              _interopRequireDefault(_dygraphDefaultAttrs);

            var _dygraphOptionsReference = require("./dygraph-options-reference");

            var _dygraphOptionsReference2 = _interopRequireDefault(
              _dygraphOptionsReference
            );
            ...
            DygraphOptions.prototype.reparseSeries = function () {
              ...
              for (var idx = 0; idx < this.labels_.length; idx++) {
                ...
                var yAxis = DygraphOptions.axisToIndex_(
                  optionsForSeries["axis"]
                );
            ...
            DygraphOptions.prototype.getForAxis = function (name, axis) {
              ...
              var defaultAxisOptions =
                _dygraphDefaultAttrs2["default"].axes[axisString];
            ...
            if (typeof process !== "undefined") {
              if ("development" != "production") {
                ...
                DygraphOptions.prototype.validateOptions_ = function () {
                  if (
                    typeof _dygraphOptionsReference2["default"] === "undefined"
                  ) {
                 ...
                 * @private
                 */
                DygraphOptions.prototype.warnInvalidOption_ = function (
                  optionName
                ) {
      ...
      16: [
        function (require, module, exports) {
          ...
          /** @type {Ticker} */
          var numericLinearTicks = function numericLinearTicks(
            a,
            b,
            pixels,
            opts,
          ...
          /** @type {Ticker} */
          var numericTicks = function numericTicks(
            a,
            b,
            pixels,
            opts,
            ...
            if (vals) {
              ...
              if (opts("logscale")) {
                ...
                var minIdx = utils.binarySearch(
                  a,
                  PREFERRED_LOG_TICK_VALUES,
                  1
                );
                var maxIdx = utils.binarySearch(
                  b,
                  PREFERRED_LOG_TICK_VALUES,
                  -1
                );
          ...
          /** @type {Ticker} */
          var dateTicker = function dateTicker(
            a,
            b,
            pixels,
            opts,
           ...
           */
          var pickDateTickGranularity = function pickDateTickGranularity(
            a,
            b,
            pixels,
            opts
           ...
           */
          var numDateTicks = function numDateTicks(
            start_time,
            end_time,
            granularity
          ) {
           ...
           * @return {!TickList}
           */
          var getDateAxis = function getDateAxis(
            start_time,
            end_time,
            granularity,
            opts,
            ...
            var accessors = utc
              ? utils.DateAccessorsUTC
              : utils.DateAccessorsLocal;
            ...
            var date_array = [];
            date_array[DateField.DATEFIELD_Y] =
              accessors.getFullYear(start_date);
      ...
      17: [
        function (require, module, exports) {
          ...
          function repeatAndCleanup(
            ...
            (function loop() {
              ...
              requestAnimFrame.call(window, function () {
                ...
                var predictOvershootStutter =
                  frameNumber + frameDelta > maxFrameArg;
          ...
          function isCanvasSupported(opt_canvasElement) {
            try {
              var canvas =
                opt_canvasElement || document.createElement("canvas");
          ...
          function dateAxisLabelFormatter(date, granularity, opts) {
            ...
            if (granularity >= DygraphTickers.Granularity.DECADAL) {
              ...
              if (
                frac === 0 ||
                granularity >= DygraphTickers.Granularity.DAILY
              ) {
                // e.g. '21 Jan' (%d%b)
                ...
                var str = "" + millis;
                return (
                  zeropad(secs) + "." + ("000" + str).substring(str.length)
                );
     ...
     */ "use strict";
            ...
            var _datahandlerDefault2 =
              _interopRequireDefault(_datahandlerDefault);
            var _datahandlerBarsError = require("./datahandler/bars-error");
            var _datahandlerBarsError2 = _interopRequireDefault(
              _datahandlerBarsError
            );
            var _datahandlerBarsCustom = require("./datahandler/bars-custom");
            var _datahandlerBarsCustom2 = _interopRequireDefault(
              _datahandlerBarsCustom
            );
            var _datahandlerDefaultFractions = require("./datahandler/default-fractions");
            var _datahandlerDefaultFractions2 = _interopRequireDefault(
              _datahandlerDefaultFractions
            );
            var _datahandlerBarsFractions = require("./datahandler/bars-fractions");
            var _datahandlerBarsFractions2 = _interopRequireDefault(
              _datahandlerBarsFractions
            );
            ...
            var _pluginsAnnotations2 =
              _interopRequireDefault(_pluginsAnnotations);
            ...
            var _pluginsChartLabels2 =
              _interopRequireDefault(_pluginsChartLabels);
            ...
            var _pluginsRangeSelector2 = _interopRequireDefault(
              _pluginsRangeSelector
            );
             ...
             */ Dygraph.prototype.__init__ = function (div, file, attrs) {
              ...
              this.file_ = file;
              this.rollPeriod_ =
                attrs.rollPeriod || Dygraph.DEFAULT_ROLL_PERIOD;
             ...
             * @private
             */ Dygraph.prototype.cascadeEvents_ = function (
              name,
              extra_props
            ) {
              ...
              if (typeof process !== "undefined") {
                if ("development" != "production") {
                  if (
                    ...
                    !_dygraphOptionsReference2["default"].hasOwnProperty(name)
                  ) {
                    console.error(
             ...
             * @private
             */ Dygraph.prototype.getNumericOption = function (
              name,
              opt_seriesName
            ) {
             ...
             * @private
             */ Dygraph.prototype.getStringOption = function (
              name,
              opt_seriesName
            ) {
             ...
             * @private
             */ Dygraph.prototype.getBooleanOption = function (
              name,
              opt_seriesName
            ) {
             ...
             * @private
             */ Dygraph.prototype.getFunctionOption = function (
              name,
              opt_seriesName
            ) {
              return /** @type{function(...)} */ this.getOption(
                name,
                opt_seriesName
              );
            };
             ...
             */ Dygraph.prototype.toDomXCoord = function (x) {
              ...
              return (
                area.x + ((x - xRange[0]) / (xRange[1] - xRange[0])) * area.w
              );
            };
            /**
             ...
             */ Dygraph.prototype.toDataXCoord = function (x) {
              ...
              if (!this.attributes_.getForAxis("logscale", "x")) {
                return (
                  xRange[0] + ((x - area.x) / area.w) * (xRange[1] - xRange[0])
                );
              } else {
             ...
             */ Dygraph.prototype.toDataYCoord = function (y, axis) {
              ...
              if (!this.attributes_.getForAxis("logscale", axis)) {
                return (
                  yRange[0] +
                  ((area.y + area.h - y) / area.h) * (yRange[1] - yRange[0])
                );
              } else {
             ...
             */ Dygraph.prototype.createInterface_ = function () {
              ...
              this.mouseOutHandler_ = function (e) {
                ...
                if (
                  utils.isNodeContainedBy(target, dygraph.graphDiv) &&
            ...
            Dygraph.prototype.resizeElements_ = function () {
              ...
              var canvasScale =
                pixelRatioOption ||
                utils.getContextPixelRatio(this.canvas_ctx_);
              ...
              var hiddenScale =
                pixelRatioOption ||
                utils.getContextPixelRatio(this.hidden_ctx_);
              ...
              for (var i = 0; i < num; i++) {
                ...
                if (!colorStr) {
                  if (colors) {
                    ...
                    var idx =
                      i % 2 ? half + (i + 1) / 2 : Math.ceil((i + 1) / 2);
             ...
             */ Dygraph.prototype.createRollInterface_ = function () {
              ...
              var display = this.getBooleanOption("showRoller")
                ? "block"
                : "none";
             ...
             */ Dygraph.prototype.createDragInterface_ = function () {
              var context = {
                ...
                px: 0,
                py: 0, // Values for use with panEdgeFraction, which limit how far outside the
                ...
                initializeMouseDown: function initializeMouseDown(
                  event,
                  g,
                  contextB
                ) {
             ...
             */ Dygraph.zoomAnimationFunction = function (frame, numFrames) {
              var k = 1.5;
              return (
                (1.0 - Math.pow(k, -frame)) / (1.0 - Math.pow(k, -numFrames))
              );
            };
            /**
             ...
             */ Dygraph.prototype.findClosestPoint = function (domX, domY) {
              ...
              for (
                var setIdx = this.layout_.points.length - 1;
                setIdx >= 0;
                --setIdx
              ) {
              ...
              return { row: closestRow, seriesName: name, point: closestPoint };
            };
            /**
             ...
             */ Dygraph.prototype.findStackedPoint = function (domX, domY) {
              ...
              var name = this.layout_.setNames[closestSeries];
              return { row: row, seriesName: name, point: closestPoint };
            };
            /**
             ...
             */ Dygraph.prototype.updateSelection_ = function (
              ...
              if (this.getOption("highlightSeriesOpts")) {
                ...
                var backgroundColor = utils.toRGB_(
              ...
              if (this.selPoints_.length > 0) {
                ...
                for (i = 0; i < this.selPoints_.length; i++) {
                  ...
                  var callback = this.getFunctionOption(
                    "drawHighlightPointCallback",
                    pt.name
                  );
             ...
             */ Dygraph.prototype.predraw_ = function () {
              ...
              this.plotter_ = new _dygraphCanvas2["default"](
                this,
                this.hidden_,
                this.hidden_ctx_,
                this.layout_
             ...
             * @private
             */ Dygraph.prototype.gatherDatasets_ = function (
              rolledSeries,
              dateWindow
            ) {
              var boundaryIds = [];
              ...
              for (seriesIdx = num_series; seriesIdx >= 1; seriesIdx--) {
                ...
                if (dateWindow) {
                  ...
                  while (
                    isInvalidValue &&
                    correctedLastIdx < series.length - 1
                  ) {
                    correctedLastIdx++;
             ...
             */ Dygraph.prototype.drawGraph_ = function () {
              ...
              var packed = this.gatherDatasets_(
                this.rolledSeries_,
                this.dateWindow_
              );
             ...
             */ Dygraph.prototype.computeYAxisRanges_ = function (extremes) {
              ...
              for (var i = 0; i < numAxes; i++) {
                ...
                var independentTicks = this.attributes_.getForAxis(
                  "independentTicks",
                  i
                );
                ...
                if (axis.valueRange) {
                  ...
                  var y0 = isNullUndefinedOrNaN(axis.valueRange[0])
                    ? axis.extremeRange[0]
                    : axis.valueRange[0];
                  var y1 = isNullUndefinedOrNaN(axis.valueRange[1])
                    ? axis.extremeRange[1]
                    : axis.valueRange[1];
                ...
                if (!ypadCompat) {
                  ...
                  if (logscale) {
                    ...
                    axis.computedValueRange[0] = utils.logRangeFraction(
                      y0,
                      y1,
                      y0pct
                    );
                    axis.computedValueRange[1] = utils.logRangeFraction(
                      y0,
                      y1,
                      y1pct
                    );
              ...
              for (var i = 0; i < numAxes; i++) {
                ...
                if (!axis.independentTicks) {
                  ...
                  var scale =
                    axis.computedValueRange[1] - axis.computedValueRange[0];
                  var tick_values = [];
            ...
            Dygraph.prototype.setXAxisOptions_ = function (isDate) {
              if (isDate) {
                ...
                /** @private (shut up, jsdoc!) */ this.attrs_.xValueParser =
                  function (x) {
                    return parseFloat(x);
                  }; // TODO(danvk): use Dygraph.numberValueFormatter here?
                /** @private (shut up, jsdoc!) */ this.attrs_.axes.x.valueFormatter =
                  function (x) {
                    return x;
                  };
             ...
             */ Dygraph.prototype.parseArray_ = function (data) {
              ...
              if (utils.isDateLike(data[0][0])) {
                ...
                this.attrs_.axes.x.ticker = DygraphTickers.dateTicker;
                this.attrs_.axes.x.axisLabelFormatter =
                  utils.dateAxisLabelFormatter; // Assume they're all dates.
                ...
                for (i = 0; i < data.length; i++) {
                  ...
                  if (
                    ...
                    console.error(
                      "x value in row " + (1 + i) + " is not a Date"
                    );
                    return null;
                  }
                ...
                this.attrs_.axes.x.ticker = DygraphTickers.numericTicks;
                this.attrs_.axes.x.axisLabelFormatter =
                  utils.numberAxisLabelFormatter;
                return data;
              }
            };
            /**
             ...
             */ Dygraph.prototype.parseDataTable_ = function (data) {
              var shortTextForAnnotationNum =
                function shortTextForAnnotationNum(num) {
                ...
                if (!this.getBooleanOption("errorBars")) {
                  for (j = 0; j < colIdx.length; j++) {
                    ...
                    if (
                      ...
                      ann.xval = row[0];
                      ann.shortText = shortTextForAnnotationNum(
                        annotations.length
                      );
                      ann.text = "";
             ...
             *     callback).
             */ Dygraph.prototype.updateOptions = function (
              input_attrs,
              block_redraw
            ) {
              ...
              var requiresNewPoints = utils.isPixelChangingOptionList(
                this.attr_("labels"),
                attrs
              );
             ...
             */ Dygraph.prototype.resize = function (width, height) {
              ...
              if ((width === null) != (height === null)) {
                console.warn(
                  "Dygraph.resize() should be called with zero parameters or " +
             ...
             */ Dygraph.prototype.visibility = function () {
              ...
              while (
                this.getOption("visibility").length <
                this.numColumns() - 1
              ) {
              ...
              if (numIsObject) {
                for (var i in num) {
                  if (num.hasOwnProperty(i)) {
                    if (i < 0 || i >= x.length) {
                      console.warn(
                        "Invalid series number in setVisibility: " + i
                      );
                    } else {
                      x[i] = num[i];
                    }
             ...
             */ Dygraph.prototype.setAnnotations = function (
              ann,
              suppressDraw
            ) {
              ...
              if (!this.layout_) {
                console.warn(
                  "Tried to setAnnotations before dygraph was ready. " +
            ...
            Dygraph.PLUGINS = [
              _pluginsLegend2["default"],
              _pluginsAxes2["default"],
              _pluginsRangeSelector2["default"], // Has to be before ChartLabels so that its callbacks are called after ChartLabels' callbacks.
              _pluginsChartLabels2["default"],
              _pluginsAnnotations2["default"],
              _pluginsGrid2["default"],
            ...
            Dygraph.defaultInteractionModel =
              _dygraphInteractionModel2["default"].defaultModel;
            Dygraph.nonInteractiveModel = Dygraph.nonInteractiveModel_ =
              _dygraphInteractionModel2["default"].nonInteractiveModel_;
    ...
    */
      ...
      22: [
        function (require, module, exports) {
          ...
          var createRotatedDiv = function createRotatedDiv(
            g,
            box,
            axis,
            classes,
            ...
            inner_div.className =
              "dygraph-label-rotate-" + (axis == 1 ? "right" : "left");
    ...
    */
          ...
          Legend.prototype.select = function (e) {
            ...
            if (legendMode === "follow") {
              ...
              var yAxisLabelWidth = e.dygraph.getOptionForAxis(
                "axisLabelWidth",
                "y"
              );
          ...
          Legend.generateLegendHTML = function (
            ...
            var formatter =
              g.getOption("legendFormatter") || Legend.defaultFormatter;
        ...
        function (require, module, exports) {
          ...
          rangeSelector.prototype.resize_ = function () {
            function setElementRect(canvas, context, rect, pixelRatioOption) {
              var canvasScale =
                pixelRatioOption || utils.getContextPixelRatio(context);
          ...
          rangeSelector.prototype.initInteraction_ = function () {
            ...
            this.setDefaultOption_(
              "interactionModel",
              _dygraphInteractionModel2["default"].dragIsPanInteractionModel
            );
          ...
          rangeSelector.prototype.drawStaticLayer_ = function () {
            ...
            ctx.lineTo(
              this.canvasRect_.w - margin,
              this.canvasRect_.h - margin
            );
          ...
          rangeSelector.prototype.drawMiniPlot_ = function () {
            ...
            var fillGradientStyle = this.getOption_(
              "rangeSelectorPlotFillGradientColor"
            );
           ...
           */
          rangeSelector.prototype.computeCombinedSeriesAndLimits_ =
            function () {
              var g = this.dygraph_;
          ...
          rangeSelector.prototype.placeZoomHandles_ = function () {
            ...
            var leftPercent = Math.max(
              0,
              (xWindowLimits[0] - xExtremes[0]) / xRange
            );
            var rightPercent = Math.max(
              0,
              (xExtremes[1] - xWindowLimits[1]) / xRange
            );
            var leftCoord =
              this.canvasRect_.x + this.canvasRect_.w * leftPercent;
            var rightCoord =
              this.canvasRect_.x + this.canvasRect_.w * (1 - rightPercent);
            var handleTop = Math.max(
              this.canvasRect_.y,
              this.canvasRect_.y +
                (this.canvasRect_.h - this.leftZoomHandle_.height) / 2
            );
            var halfHandleWidth = this.leftZoomHandle_.width / 2;
            this.leftZoomHandle_.style.left =
              leftCoord - halfHandleWidth + "px";
          ...
          rangeSelector.prototype.drawInteractiveLayer_ = function () {
            ...
            if (!zoomHandleStatus.isZoomed) {
              ...
              var rightHandleCanvasPos = Math.min(
                width,
